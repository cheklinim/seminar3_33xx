...
* Для внесения изменений всегда создается новая ветка, делаем это с помощью известной нам команды:

        git branch <new branch name>

    Вносим свои правки и обязательно их коммитим.

* Переносим наши правки в GitHub с помощью команды:

        git push

* После того, как наши правки отразились в GitHub (см. remote), мы можем предложить их хозяину другого репозитория. Сделать это можно с помощью кнопок 
