...
Для того, чтобы загрузить изменения из удалённого репозитория нужно использовать команду
...
Для того, чтобы добавить удаленный репозиторий к существующему локальному нужно использовать команду:

    git remote add

### Клонирование удаленного репозитория

Для того, чтобы склонировать удаленный репозиторий к себе на компьютер нужно использовать команду:
