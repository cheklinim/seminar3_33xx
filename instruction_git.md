...
Команда git pull позволяет сначала забрать изменения из указанного удалённого репозитория, а затем слить их с текущей веткой.
...
## Pull Request или предложение о внесении изменений в другой проект
Для того, чтобы воспользоваться данной командой, Вам потребуется аккаунт на GitHub. Регистрация бесплатная и требует указания лишь имени пользователя и электронной почты.
