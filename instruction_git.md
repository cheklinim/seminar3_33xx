...
## Внесение изменений с "другого компьютера" 
...
1. Сделать полную копию удаленного репозитория на GitHub с помощью кнопки [fork], она должна появиться в нашем собственном репозитории (как если бы мы делали его сами)

2. Создать на своем ПК отдельную папку и клонировать в наш локальный репозиторий скопированный проект с помощью команды:

        git clone <скопированная ссылка>

    Как только файл появляется в нашем локальном репозитории необходимо сменить директорию:

        cd <папка, в которую нужно войти>

3. Для внесения изменений всегда создается новая ветка, сделать это можно с помощью команды:

        git branch <new branch name>

    Внести свои правки и обязательно их закоммитить.

4. Перенести наши правки в GitHub с помощью команды:

        git push

5. После того, как наши правки отразились в GitHub (см. remote), мы можем предложить их хозяину другого репозитория. Сделать это можно с помощью кнопок 
"compare and pull request" либо "contribute". При этом, мы можем дополнить наше предложение сопроводительным письмом.

## Настройка совместной удаленной работы

Для того, чтобы настроить совместную работу необходимо:

* Создать аккаунт на GitHub.com

* Создать локальный репозиторий

* “Подружить” наш локальный и удалённый репозитории. GitHub при создании нового репозитория подскажет, как это можно сделать

* Отправить (push) наш локальный репозиторий в удалённый (на GitHub), при этом, необходимо будет авторизоваться на удалённом репозитории
