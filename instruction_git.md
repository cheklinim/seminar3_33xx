...
При необходимость клонировать существующий удаленный репозиторий в ситуации, когда вы решаете поработать над уже существующим кодом локально нужно использовать команду:

    git clone <адрес репозитория, который копируем на свой ПК https://github.com/...>
...
При первом ее использовании потребуется авторизация на внешнем репозитории.

### Выгрузка из удаленного репозитория

Для того чтобы скачать все изменения из текущего удаленного репозитория и автомотически сделать слияние с нашей версией используется команда:

    git pull
### Команда для предложения изменений в удаленном репозитории 

Для участия в открытых проектах на GitHub используется создание fork
...
* создаем новую ветку и уже в ней вносим все изменения
* коммитем изменения 
