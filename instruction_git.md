...
Перед началом работы с удаленным репозиторием необходимо зарегистрироваться на https://github.com.
GitHub - это сервис, который позволяет интегрироваться с программой git и работать удаленно.
При связывании git и GitHub необходимо пройти авторизацию.
...
Для того чтобы получить изменения из переданного удаленного репозитория и обновить рабочую копию в соответствии с удаленным репозиторием, используется команда:

    git pull <имя удаленного репозитория>

## Отправка изменений в удаленный репозиторий

Для того чтобы загрузить в удаленный репозиторий свои локальные изменения необходимо выполнить команду:
...
1. Делаем FORK интересующего нас аккаунта на GitHub.
2. Делаем git clone для нашей версии чужого репозитория.
3. Создаем ветку с предлагаемыми изменениями.
4. Произволим все изменения только в этой ветке.
5. Отправляем изменения на свой аккаунт.
6. После этого на GitHub появится кнопка для отправки предлагаемых изменений автору скопированного репозитория (pull request).
