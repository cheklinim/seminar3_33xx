...
Рассмотрим алгоритм действий, если мы хотим поучаствовать в созданном кем-то проекте и предложить свои изменения:

* Находим нужный удаленный репозиторий.
* Нажимаем кнопку **Fork**.
* Клонируем этот репозиторий в локальную папку командой **git clone**.
* В терминале набираем **cd (название папки в которую нужно перейти)**.
* Создаем новую ветку.
* Делаем изменения, сохраняем, коммитим и когда все готово набираем команду: **git push**.

Коротко, на слайде:

![Pull_req](pull_request.png)
