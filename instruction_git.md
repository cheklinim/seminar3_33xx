...
Чтобы изменения, внесенные локально, загрузить в удаленный репозиторий, воспользуйтесь командой:

        git push

Данной команде нужно право на внесение изменений в репозиторий.

Перед использованием данной команды необходимо убедиться, что локальные изменения вносились для последней версии удаленного репозитория. Проверить это можно, используя команду pull, описанную выше.