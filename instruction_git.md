...
Для того чтобы  получить данные из удаленного проекта, которых у вас ещё нет, используется команда:

    git pull

### Создание копии удаленного репозитория

Для того чтобы создать копию удаленного репозитория исспользуется команда:

    git clone

### Смена папки

Для того чтобы сменить папку, в которой будет проводиться работа, используется команда терминала:
