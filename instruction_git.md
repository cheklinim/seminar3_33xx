...
Команда используется для извлечения и загрузки содержимого из удаленного репозитория и немедленного обновления локального репозитория этим содержимым. Слияние удаленных вышестоящих изменений в локальный репозиторий — это обычная задача рабочего процесса, возникающая при совместной работе на основе системы Git.

    git pull

## Перенос удаленного репозитория

 Сама команда имеет такую форму записи:
...
:) Больше никаких команд, которые мы проходили, я не нашел. Там конечно есть команды :
